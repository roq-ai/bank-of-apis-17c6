...
import { getCreditCardById } from 'apiSdk/credit-cards';
import { CreditCardInterface } from 'interfaces/credit-card';

function CreditCardViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('credit_card', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/credit-cards/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Maximum Limit" text={data?.maximum_limit} />
