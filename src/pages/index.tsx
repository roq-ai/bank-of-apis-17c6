...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Bank of Apis`}</title>

        <meta
          name="description"
          content="Bank of Apis - Unifying your banking experience. View and manage all your accounts, transactions, credit cards and more from different banks in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Bank of Apis - Unifying your banking experience. View and manage all your accounts, transactions, credit cards and more from different banks in one place.`}
            </Text>
            <Box
