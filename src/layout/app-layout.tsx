...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['account-owner', 'account-manager', 'end-user', 'financial-advisor'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Accounts', path: '/accounts', entity: 'account', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    {
      name: 'Credit Cards',
      path: '/credit-cards',
      entity: 'credit_card',
