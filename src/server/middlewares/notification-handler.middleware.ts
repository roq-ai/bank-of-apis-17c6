...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A new financial report has been generated by the system. Please review it at your earliest convenience..create': {
    roles: ['account-owner', 'account-manager'],
    key: 'financial_report_generated',
    tenantPath: [],
    userPath: [],
  },
  'A new support ticket has been created by an end user. Please review and address it promptly..create': {
    roles: ['account-owner', 'account-manager'],
    key: 'support_ticket_created',
    tenantPath: [],
    userPath: [],
  },
  'A new policy has been implemented by the account manager. Please review and ensure compliance..create': {
    roles: ['account-owner', 'end-user', 'financial-advisor'],
    key: 'new_policy_implemented',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['account-owner', 'account-manager', 'end-user', 'financial-advisor'];
